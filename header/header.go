...
// +----------+---------+------------+-----------------+-------------------+-----------------+----------+------------+----------+
// |HeaderType|CoderType|CompressType|  Service	       |      Module       |  Method	     |    Seq   | RequestLen | Checksum |
// +----------+---------+------------+-----------------+-------------------+-----------------+----------+------------+----------+
// | uint16   | uint16  |   uint16   | uvarint+ string | uvarint + string  | uvarint +string |  uvarint |   uvarint  |  uint32  |
// +----------+---------+------------+-----------------+-------------------+-----------------+----------+------------+----------+
type Header struct {
	sync.RWMutex
	Type         header_type
